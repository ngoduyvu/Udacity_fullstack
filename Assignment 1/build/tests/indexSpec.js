...
describe('Test Main API Endpoint Response', function () {
    ...
    it('Test Negative Height and Width', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('Test Zero Height and Width', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/api/image?filename=" + VALID_FILES[randomIndex] + "&height=0&width=0")];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(400);
                    done();
